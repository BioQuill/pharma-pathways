// Core molecules that were originally defined inline in Index.tsx
// Extracted to a shared module so they're available in getAllMolecules()
import { type MoleculeProfile } from './moleculesData';
import { calculateProbabilityScores, generateMarketProjections } from './scoring';

export const coreMolecules: MoleculeProfile[] = [
  {
    id: "RETA-01",
    ...
    retrospectivePhases: [
      ...
      },
      {
        ...
        keyData: [
          ...
          "Novel adaptive trial design with biomarker enrichment",
          "Brain shuttle technology enables potentially lower doses"
        ],
        scoreAtTime: 52,
