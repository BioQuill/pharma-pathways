...
export const TTM_BREAKDOWN_DATA: TTMBreakdown[] = [
  ...
  { therapeuticArea: 'Cardiovascular', discovery: 3.65, clinical: 6.75, regulatory: 1.08, marketAccess: 1.08, launch: 0.95, totalYears: 13.5, totalMonths: 162 },
  { therapeuticArea: 'Neurology', discovery: 4.05, clinical: 7.5, regulatory: 1.2, marketAccess: 1.2, launch: 1.05, totalYears: 15, totalMonths: 180 },
  ...
  { therapeuticArea: 'Musculoskeletal & Rheumatology', discovery: 2.84, clinical: 5.25, regulatory: 0.84, marketAccess: 0.84, launch: 0.74, totalYears: 10.5, totalMonths: 126 },
  { therapeuticArea: 'Infectious Disease', discovery: 2.43, clinical: 4.5, regulatory: 0.72, marketAccess: 0.72, launch: 0.63, totalYears: 9, totalMonths: 108 },
  { therapeuticArea: 'Respiratory & Pulmonary', discovery: 2.97, clinical: 5.5, regulatory: 0.88, marketAccess: 0.88, launch: 0.77, totalYears: 11, totalMonths: 132 },
  ...
  { therapeuticArea: 'Rare Disease & Orphan', discovery: 2.16, clinical: 4, regulatory: 0.64, marketAccess: 0.64, launch: 0.56, totalYears: 8, totalMonths: 96 },
  { therapeuticArea: 'Vaccines & Preventive', discovery: 2.03, clinical: 3.75, regulatory: 0.6, marketAccess: 0.6, launch: 0.53, totalYears: 7.5, totalMonths: 90 },
  ...
  { therapeuticArea: 'Pain & Anaesthesia', discovery: 2.43, clinical: 4.5, regulatory: 0.72, marketAccess: 0.72, launch: 0.63, totalYears: 9, totalMonths: 108 },
  { therapeuticArea: 'Hematology (non-oncology)', discovery: 2.7, clinical: 5, regulatory: 0.8, marketAccess: 0.8, launch: 0.7, totalYears: 10, totalMonths: 120 },
